...
train_data = Res34_low(dataset_transform, train_txt_path)
test_data = Res34_low(dataset_transform, test_txt_path)

high_train = Res34_low(dataset_transform, train_high_path)
high_test = Res34_low(dataset_transform, test_high_path)
