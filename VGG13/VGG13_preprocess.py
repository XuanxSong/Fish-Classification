...
train_data = VGG16_low(dataset_transform, train_txt_path)
test_data = VGG16_low(dataset_transform, test_txt_path)

high_train = VGG16_low(dataset_transform, train_high_path)
high_test = VGG16_low(dataset_transform, test_high_path)
