...
train_data = Dense(dataset_transform, train_txt_path)
test_data = Dense(dataset_transform, test_txt_path)

high_train = Dense(dataset_transform, train_high_path)
high_test = Dense(dataset_transform, test_high_path)
