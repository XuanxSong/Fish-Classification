...
# 更改此处参数测试不同的网络模型
best_weight_path = "./weights/best_classify_sn10.pt"
last_weight_path = "./weights/last_classify_vgg16.pt"
best_high_path = "./weights/best_classify_sn10_high.pt"
last_high_path = "./weights/last_classify_vgg16_high.pt"

test_data = Squeeze10_preprocess.test_data
high_test_data = Squeeze10_preprocess.high_test

data_loader = DataLoader(high_test_data, 32, shuffle=False, num_workers=4)

model = Squeeze10_Net.SqueezeNet1_0
