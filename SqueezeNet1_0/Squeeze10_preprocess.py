...
train_data = SN10_low(dataset_transform, train_txt_path)
test_data = SN10_low(dataset_transform, test_txt_path)

high_train = SN10_low(dataset_transform, train_high_path)
high_test = SN10_low(dataset_transform, test_high_path)
