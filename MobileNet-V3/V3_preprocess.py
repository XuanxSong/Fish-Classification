...
train_data = V3_low(dataset_transform, train_txt_path)
test_data = V3_low(dataset_transform, test_txt_path)

high_train = V3_low(dataset_transform, train_high_path)
high_test = V3_low(dataset_transform, test_high_path)
