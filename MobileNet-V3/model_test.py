...
# 更改此处参数测试不同的网络模型
best_weight_path = "./weights/best_classify_v3l.pt"
last_weight_path = "./weights/last_classify_v3l.pt"
best_high_path = "./weights/best_classify_v2_high.pt"
last_high_path = "./weights/last_classify_vgg16_high.pt"

test_data = V3_preprocess.test_data
high_test_data = V3_preprocess.high_test

data_loader = DataLoader(test_data, 32, shuffle=False, num_workers=4)

model = V3_Net.MobileNetV3_large
