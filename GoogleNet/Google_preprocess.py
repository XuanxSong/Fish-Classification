...
train_data = Google(dataset_transform, train_txt_path)
test_data = Google(dataset_transform, test_txt_path)

high_train = Google(dataset_transform, train_high_path)
high_test = Google(dataset_transform, test_high_path)
