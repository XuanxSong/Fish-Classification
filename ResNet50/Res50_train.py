...
config = {
    ...
    'test_batch': 32,  # 测试集大小
    'net': Res50_Net.model,  # 网络判断类别需在VGG16_train.py处更改
...
train_dataloader = DataLoader(Res50_preprocess.high_train, config['train_batch'], shuffle=True, num_workers=4)
test_dataloader = DataLoader(Res50_preprocess.high_test, config['test_batch'], shuffle=False, num_workers=4)
