...
# 更改此处参数测试不同的网络模型
best_weight_path = "./weights/best_classify_vgg16.pt"
last_weight_path = "./weights/last_classify_vgg16.pt"
best_high_path = "./weights/best_classify_vgg16_high.pt"
last_high_path = "./weights/last_classify_vgg16_high.pt"

test_data = VGG16_preprocess.test_data
high_test_data = VGG16_preprocess.high_test
