...
# 更改此处参数测试不同的网络模型
best_weight_path = "./weights/best_classify_x10.pt"
best_high_path = "./weights/best_classify_x20_high.pt"

test_data = ShuffleV2_preprocess.test_data
high_test_data = ShuffleV2_preprocess.high_test

data_loader = DataLoader(high_test_data, 1, shuffle=False, num_workers=4)

model = Shuffle_x10_Net.ShuffleNet_x10
