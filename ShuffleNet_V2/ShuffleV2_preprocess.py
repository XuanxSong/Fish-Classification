...
train_data = SFV2_low(dataset_transform, train_txt_path)
test_data = SFV2_low(dataset_transform, test_txt_path)

high_train = SFV2_low(dataset_transform, train_high_path)
high_test = SFV2_low(dataset_transform, test_high_path)
