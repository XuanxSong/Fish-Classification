...
# todo 数据读取类的名字没必要区分高清低清
class VGG19_low(Dataset, ABC):
...
train_data = VGG19_low(dataset_transform, train_txt_path)
test_data = VGG19_low(dataset_transform, test_txt_path)

high_train = VGG19_low(dataset_transform, train_high_path)
high_test = VGG19_low(dataset_transform, test_high_path)
