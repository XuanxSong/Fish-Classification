...
# 更改此处参数测试不同的网络模型
best_weight_path = "./weights/best_classify_v2(pretrained).pt"
...
test_data = V2_preprocess.test_data
high_test_data = V2_preprocess.high_test

data_loader = DataLoader(test_data, 1, shuffle=False, num_workers=4)
# print(len(data_loader))

model = V2_Net.MobileNetV2
