...
train_data = VGG11_low(dataset_transform, train_txt_path)
test_data = VGG11_low(dataset_transform, test_txt_path)

high_train = VGG11_low(dataset_transform, train_high_path)
high_test = VGG11_low(dataset_transform, test_high_path)
